...
const seedData = async () => {
    try {
        ...
        const users = await User.insertMany([
            { name: 'Alice Rahman', email: 'alice@example.com', password: 'password123' },
            { name: 'Karim Hossain', email: 'karim@example.com', password: 'password123' },
            { name: 'Nusrat Jahan', email: 'nusrat@example.com', password: 'password123' }
        ]);
